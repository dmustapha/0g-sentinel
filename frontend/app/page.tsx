...
export default function OverviewPage({ searchParams = {} }: Readonly<{
  ...
  return <><section className="ledger-hero"><div className="ledger-grid" aria-hidden="true" /><div className="wrap hero-ledger">
    ...
    <div className="action-row"><Link href="/agents" className="button primary">Browse recent ProofLocks</Link>
      <Link href="/proof" className="button">Verify a historical proof</Link></div></div></section>
