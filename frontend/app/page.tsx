...
export default function OverviewPage({ searchParams = {} }: Readonly<{
  ...
  return <><section className="ledger-hero"><div className="ledger-grid" aria-hidden="true" /><div className="wrap hero-ledger">
    <div><span className="eyebrow hero-enter" style={{ animationDelay: "0ms" }}>ProofLock · Network configuration · Chain ID 16661</span><h1 className="hero-enter" style={{ animationDelay: "70ms" }}>Admission should be <em>provable.</em></h1>
      <p className="hero-lede hero-enter" style={{ animationDelay: "140ms" }}>Sentinel resolves an ERC-8004 identity, binds its current wallet to typed checks and verified 0G evidence, then issues a seven-day lease that AgentGateV2 can enforce.</p>
      <div className="action-row hero-enter" style={{ animationDelay: "210ms" }}><FeaturedProofLink />
        <Link href="/proof" className="button">Verify another proof</Link></div>
      <p className="hero-lede hero-enter" style={{ animationDelay: "210ms" }}>Dependency configuration is not service health: ERC-8004 identity, 0G Compute, 0G Storage, RegistryV2, and AgentGateV2 are observed independently.</p></div>
