...
export function ProofCoverageGrid({ basis = "current", coverage }: { basis?: "current" | "registry"; coverage?: number | null }) {
  if (coverage == null) return <section className="evidence-card coverage-card bp-bracket" aria-labelledby="coverage-title">
  ...
  return <section className="evidence-card coverage-card bp-bracket" aria-labelledby="coverage-title">
    <span className="bp-corners" aria-hidden="true" />
