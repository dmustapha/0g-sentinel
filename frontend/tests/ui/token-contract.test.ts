...
const CANONICAL_TOKENS = new Map<string, string>([
  ...
  ["--surface-paper", "var(--color-graphite-900)"], ["--surface-paper-muted", "var(--color-graphite-800)"],
  ["--text-on-dark", "var(--color-paper-50)"], ["--text-on-paper", "var(--color-paper-50)"],
  ["--action-on-dark", "var(--color-violet-400)"], ["--action-on-paper", "var(--color-violet-400)"],
